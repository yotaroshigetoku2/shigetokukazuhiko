    ...
    <section id="contact_outline">
      <div class="modalon_out">
        ...
        <div class="contact_col">
          ...
          <div class="volunteer green_box">
            ...
            <p>活動をお手伝いいただけるボランティアさんを募集しています！<br>例）
            <ul>
      ...
      <div class="modal-content green_box">
        <div class="modal-inner">
          ...
          <ul>
            <li>◎⼝座名(共通)　三河道州制研究会　代表　重徳和彦</li>
            <li>〇岡崎信⽤⾦庫本店営業部　普通⼝座９０４０１８４</li>
            <li>〇⻄尾信⽤⾦庫岡崎⽀店　 普通⼝座１０８８８２６</li>
            <li>〇三菱UFJ 銀⾏岡崎⽀店 普通⼝座０１２７９０３</li>
          </ul>
          <p>※恐れ入りますが、振込手数料はご本人様負担をお願いいたします。</p>
          <div class="form_btn">
            <a href="<?php echo esc_url(home_url()); ?>/contact_form/">寄付フォームへ</a>
          </div>
        </div>
      </div>
    </section>
