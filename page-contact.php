    ...
    <section id="contact_outline">
      <div class="modalon_out">
        ...
        <div class="contact-intro">
          <div class="kifu-intro intro-box">
            ...
            <button class="form-btn modal_open">
              ご寄付
            </button>
          </div>
          <div class="poster-intro intro-box">
            <div class="contact-intro-header">
              <h3>ポスター掲示<br><span>【選挙区：岡崎市・西尾市】</span></h3>
            </div>
            <div class="contact-intro-text">
              <p><b>「広報板・ポスター」</b>の掲示にご協力いただける方を募集しております！<br>
                （壁に直接両面テープで貼付するか、広報掲示板を設置するかのいずれかでお願いしております。）</p>
            </div>
            <button class="form-btn" onclick="window.location.href='<?php echo esc_url(home_url()); ?>/contact_form/'">ポスター掲示</button>
          </div>
          <div class="volunteer-intro intro-box">
            <div class="contact-intro-header">
              <h3>ボランティア登録</h3>
            </div>
            <div class="contact-intro-text">
              <p>活動をお手伝いいただけるボランティアさんを募集しています！<br></p>
              <p>例）<br>・郵便物の発送作業（宛名貼付、封入）をはじめとした事務所内での作業のお手伝い<br>
                ・活動報告紙（しげとく通信）をご近所・お知合いにお渡し（お配り）いただく
              </p>
            </div>
            <button class="form-btn" onclick="window.location.href='<?php echo esc_url(home_url()); ?>/contact_form/'">ボランティア登録</button>
          </div>
          <div class="opinions-intro intro-box">
            <div class="contact-intro-header">
              <h3>ご意見やお問い合わせはこちらからよろしくお願いします。</h3>
            </div>
            <button class="form-btn" onclick="window.location.href='<?php echo esc_url(home_url()); ?>/contact_form/'">お問い合わせ</button>
          </div>
        </div>
      </div>
      ...
      <div class="modal-content green_box">
        <div class="modal-inner">
          <div class="contact-hide-btn"><span></span><span></span></div>
          <div class="kifu-explain">
            <h4>直接お振込いただける方</h4>
            ...
            <p style="margin-top: 2vw;">◎口座：立憲民主党愛知県第12区総支部　代表　重徳和彦</p>
            ...
            <button class="form-btn" onclick="loction.href='<?php echo esc_url(home_url()); ?>/kifu_form/'">寄付フォームへ</button>
          </div>
        </div>
      </div>
    </section>
